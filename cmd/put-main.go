...
EXAMPLES:
  ...
  4. Put an object to Buckit storage using sse-c encryption
  ...
  5. Put an object to Buckit storage using sse-kms encryption
     {{.Prompt}} {{.HelpName}} --enc-kms path-to/object play/mybucket/object

  6. Put an object to Buckit storage and assign REDUCED_REDUNDANCY storage-class to the uploaded object.
